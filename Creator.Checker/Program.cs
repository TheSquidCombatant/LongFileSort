...
namespace LongFileSort.Creator.Checker;
...
internal class Program
{
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            CreatorCheckerHelper.Process(GetOptions(args));
    ...
    private static CreatorOptions GetOptions(string[] args, string defaultFileName = "appsettings.json")
    {
        ...
        return JsonSerializer.Deserialize<CreatorOptions>(File.ReadAllText(optionsPath));
    }
}
